...
public class RestControlTimesheet {
	...
	@PostMapping("/ajouterMissionExterne")
	public int ajouterMissionExterne(@RequestBody MissionExterne missionExterne) {
		itimesheetservice.ajouterMission(missionExterne);
		return missionExterne.getId();
	}
