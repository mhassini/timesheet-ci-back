...
public class RestControlEmploye {
   ...
   @PutMapping(value = "/affecterContratAEmploye/{idcontrat}/{idemp}") 
	...
	// http://localhost:8081/SpringMVC/servlet/affecterContratAEmploye/6/1
//   @PostMapping(value = "/affecterContratAEmploye/{ident}") 
//	public void addandAssign(@RequestBody Employe employe, @PathVariable("ident") int entId)
//	{
//		iemployeservice.addAndAssign(employe, entId);
//	}
